...
.onUpdate((change, context) => {
    ...
    updateAuthoredEntries(userData, "main_feed")
    updateAuthoredEntries(userData, "stories_feed")
    updateAuthoredEntries(userData, "SocialNetwork_Posts")
    updateAuthoredEntries(userData, "socialnetwork_stories")
